...
summary: BCerT is an Eclipse-based tool for certifying model transformations and grammar-to-grammar transpilers with B. It extends the <a href="https://vasco.imag.fr/tools/meeduse/" target="_blank">Meeduse</a> Language Workbench with new features.
sidebar: mydoc_sidebar
permalink: index.html
toc: false
---

{% include note.html content="`The current version applies Classical B. Note that we are actively working on the integration of Event-B within the tool.`" %}
